...
There are different ways on how to archive Datasets ([archiving datasets](https://openbis.readthedocs.io/en/latest/system-documentation/configuration/archiving-datasets.html#eln-lims) or [Empa archiving dataset type](/documentation/openbis/empa-specific/archive/)).
...
(Via [ELN interface](https://openbis.readthedocs.io/en/latest/user-documentation/general-users/data-upload.html#data-upload-via-web-ui) or via [Empa-Dropbox mechanism](/documentation/openbis/empa-specific/data_upload/uploading_large_data))
