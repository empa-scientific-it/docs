...
<CustomBreadcrumbs
  crumbs={[
    ...
    { label: 'Dropbox plugins', link: '/documentation/openbis/empa-specific/data_upload/dropbox' },
  ]}
/>
...
For more information on the ELN-LIMS dropbox plugin, check our documentation [here](/documentation/openbis/empa-specific/data_upload/uploading_large_data).
...
To learn how to use the existing default **ELN-LIMS dropbox** plugin , check our documentation [here](/documentation/openbis/empa-specific/data_upload/uploading_large_data).
...
If you need any assistance in developing and deploying a dropbox plugin, check our [support page](/documentation/openbis/getting-started/support/).
