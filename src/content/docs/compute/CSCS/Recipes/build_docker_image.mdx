...
CSCS provides and maintains the [Container Engine](https://confluence.cscs.ch/spaces/KB/pages/894960480/Container+Engine) (CE), a set of tools to help users run containerized applications exploiting all the features of the underlying hardware.
...
Such file tells the CE where to look for the image to run, which folders to mount inside the container, and [many other options](https://confluence.cscs.ch/spaces/KB/pages/894960480/Container+Engine#ContainerEngine-EDFReferenceedf_reference) we might need/want to customize.
...
- [The Container Engine](https://confluence.cscs.ch/spaces/KB/pages/894960480/Container+Engine)
