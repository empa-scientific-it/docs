...
## Two Interfaces
**Links to openBIS of your lab [here](/documentation/openbis/pages_for_labs/).** 
...
- **As an Instance Admin** with the credentials you get after sending the support form for new Instance Admins [here](/documentation/openbis/getting-started/support/#instance-admins) 
...
To login via [SWTICHaai](https://www.switch.ch/aai/) you open the webpage of your [instance](/documentation/openbis/pages_for_labs/) and you need to follow the steps:
...
The admin and the user account are handled separately. You open the page from your [instance](/documentation/openbis/pages_for_labs/) and follow this steps:
