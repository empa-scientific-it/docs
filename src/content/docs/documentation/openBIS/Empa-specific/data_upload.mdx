...
2. **Via the default _eln-lims-dropbox_ mechanism for data files > 10 GB**: Check our Empa internal documentation [here](/documentation/openbis/empa-specific/data_upload/uploading_large_data/), which is different to the ETH documentation, because at Empa the so called _eln-lims-dropbox folder_ is located on special lab folders on the `N:`drive.
...
<CardGrid>
  <CustomCard title="<a href='/documentation/openbis/empa-specific/data_upload/dropbox'>Dropbox plugins</a>" />
  <CustomCard title="<a href='/documentation/openbis/empa-specific/data_upload/uploading_large_data/'>Upload large data sets</a>" />
</CardGrid>
