...
<CardGrid>
  <Card
    title="<a href='/documentation/openbis/how-to-and-use-cases/dynamic_properties/masterdata_import_object'>Masterdata import to create objects including dynamic properties</a>"
  />
  <Card
    title="<a href='/documentation/openbis/how-to-and-use-cases/dynamic_properties/property_email'>Batch register e-mails with active link</a>"
  />
  <Card
    title="<a href='/documentation/openbis/how-to-and-use-cases/dynamic_properties/property_object'>Get value of a property in an object</a>"
  />
  <Card
    title="<a href='/documentation/openbis/how-to-and-use-cases/dynamic_properties/property_spreadsheet'>Read/write programmatically into spreadsheet</a>"
  />
  <Card
    title="<a href='/documentation/openbis/how-to-and-use-cases/dynamic_properties/table_attachment'>Add attachment to table in objects</a>"
  />
</CardGrid>
