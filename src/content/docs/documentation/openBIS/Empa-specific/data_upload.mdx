...
<CardGrid>
  <Card
    title="<a href='/documentation/openbis/empa-specific/data_upload/dropbox'>Dropbox plugins</a>"
  />
  <Card
    title="<a href='/documentation/openbis/empa-specific/data_upload/uploading_large_data/'>Upload large data sets</a>"
  />
</CardGrid>
